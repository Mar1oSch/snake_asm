...
section .bss
    ...
    ; If this SNAKE_PTR is 0, the constructor will create a new snake object.
...
.get_tail_position:
    mov r8, [rel SNAKE_PTR]
    mov r8, [r8 + snake.tail_ptr]
...
.destroy_object:
    ; Use the local SNAKE_PTR to free the memory space and set it back to 0.
